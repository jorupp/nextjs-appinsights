...
console.log('configuring Application Insights via app-insights.js');
try {
    ...
    global.__APP_INSIGHTS_CLIENT__ = appInsightsClient;
    global.__APP_INSIGHTS_WRAP_WITH_CORRELATION_CONTEXT__ = appInsights.wrapWithCorrelationContext;
